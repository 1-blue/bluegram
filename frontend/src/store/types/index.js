...
// 2022/01/16 - 특정 게시글의 댓글들 요청 - by 1-blue
...
// 2022/01/21 - 특정 유저의 게시글들 세부 정보 요청 - by 1-blue
export const LOAD_POSTS_DETAIL_OF_USER_REQUEST = "LOAD_POSTS_DETAIL_OF_USER_REQUEST";
export const LOAD_POSTS_DETAIL_OF_USER_SUCCESS = "LOAD_POSTS_DETAIL_OF_USER_SUCCESS";
export const LOAD_POSTS_DETAIL_OF_USER_FAILURE = "LOAD_POSTS_DETAIL_OF_USER_FAILURE";

// 2022/01/23 - 로그인한 유저의 북마크 추가 요청 - by 1-blue
export const APPEND_POST_OF_BOOKMARK_REQUEST = "APPEND_POST_OF_BOOKMARK_REQUEST";
export const APPEND_POST_OF_BOOKMARK_SUCCESS = "APPEND_POST_OF_BOOKMARK_SUCCESS";
export const APPEND_POST_OF_BOOKMARK_FAILURE = "APPEND_POST_OF_BOOKMARK_FAILURE";

// 2022/01/23 - 로그인한 유저의 북마크 제거 요청 - by 1-blue
export const REMOVE_POST_OF_BOOKMARK_REQUEST = "REMOVE_POST_OF_BOOKMARK_REQUEST";
export const REMOVE_POST_OF_BOOKMARK_SUCCESS = "REMOVE_POST_OF_BOOKMARK_SUCCESS";
export const REMOVE_POST_OF_BOOKMARK_FAILURE = "REMOVE_POST_OF_BOOKMARK_FAILURE";

// 2022/01/23 - 로그인한 유저의 북마크된 게시글들 요청 - by 1-blue
export const LOAD_POSTS_OF_BOOKMARK_REQUEST = "LOAD_POSTS_OF_BOOKMARK_REQUEST";
export const LOAD_POSTS_OF_BOOKMARK_SUCCESS = "LOAD_POSTS_OF_BOOKMARK_SUCCESS";
export const LOAD_POSTS_OF_BOOKMARK_FAILURE = "LOAD_POSTS_OF_BOOKMARK_FAILURE";
